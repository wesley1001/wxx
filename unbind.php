...
<label class="control-label" disable>请输入智能卡号</label>
<input class="form-control" type="text" name="card_number"/>
<input type="hidden" name="open_id" value=<?php echo $_GET["open_id"] ?>/>
<input type="hidden" name="act" value="unbind" />
<button class="btn btn-default" style="margin-top:10px"  type="submit">解绑</button>
</form>
</div>
</body>
</html>
